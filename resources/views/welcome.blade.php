    ...
    <div class="row">
        <div class="col-7 ml-auto">
            <p class="lead text-muted text-justify animate__backInRight">
                ...
                do meu portifólio aqui apresentados.
            </p>
        </div>
    </div>
</div>
...
<div class="container mt-4 py-2">
    <h3 id="projetos" class="jumbotron-heading mb-4 text-center text-title">Projetos</h3>
<div class="row row-cols-1 row-cols-md-3">
    ...
    <div class="col mb-4">
        <div class="card h-100">
            ...
            <p class="card-text text-justify font-weight-lighter">
                A aplicação utiliza a linguagem de programação PHP e o framework Laravel, para criar um ecommerce.
            </p>
            </div>
            <div class="card-footer">
                <div class="container">
